...
var CookiesManager = {
    setCookie : function (name, value, expires, path, domain, secure) {
        ...
        if(typeof expires != 'number'){
            ...
            var expires_date = new Date( (new Date()).getTime() + (expires*24*60*60) );
            expires = ' expires=' + expires_date.toGMTString() + ';';
        }
        var d = (domain) ? ';domain=' + domain : '';
        var s = ( secure ) ? ";secure" : "";
        var path = ( path ) ? ';Path=' + path : ';Path=/';
        document.cookie = name + "=" + value + ";" + expires + path + d + s;
    },
...
/*
function share42(f){(function($){
        $(function(){ 
            $('div.share42init').each(function(){<img src="/js/icons.png" width="96" height="16" />
                u=$(this).attr('data-url');<img src="/js/icons.png" width="96" height="16" />
                ...
                var l='';for(j=0;j<s.length;j++)l+='<a rel="nofollow" style="display:inline-block;vertical-align:bottom;width:16px;height:16px;margin:0 8px 6px 0;outline:none;background:url('+f+'icons.png) -'+16*j+'px 0" href='+s[j]+' target="_blank"></a>';
                $(this).html('<span >'+l+'</span>');})})})(jQuery)
};
*/